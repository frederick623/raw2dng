...
add_library(jxl STATIC ${JPEGXL_INTERNAL_OBJECTS} 
$<TARGET_OBJECTS:hwy-obj>
$<TARGET_OBJECTS:brotlicommon-static-obj>
$<TARGET_OBJECTS:brotlidec-static-obj>
$<TARGET_OBJECTS:brotlienc-static-obj>
)
target_include_directories(jxl PUBLIC ${PROJECT_SOURCE_DIR})